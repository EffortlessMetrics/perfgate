//! Storage helpers for local and remote JSON receipts.
//!
//! This module keeps filesystem/object-store concerns out of the CLI command
//! dispatch layer so command handlers can depend on a small receipt I/O API.
