//! JSON persistence helpers for local files and remote object-store URIs.
//!
//! This module owns the storage boundary for CLI commands so command handlers
//! can work with receipt paths without mixing orchestration and I/O details.
