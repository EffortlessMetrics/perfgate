...
- [ ] 1. Set up BDD testing framework
  - [ ] 1.1 Add cucumber dependency and configure test runner
  ...
  - [ ] 1.2 Create BDD step definitions for CLI commands
  ...
  - [ ] 1.3 Write BDD feature file for run command
  ...
  - [ ] 1.4 Write BDD feature file for compare command
  ...
  - [ ] 1.5 Write BDD feature file for md command
  ...
  - [ ] 1.6 Write BDD feature file for github-annotations command
...
- [ ] 2. Checkpoint - Verify BDD tests pass
  - Ensure all BDD tests pass with `cargo test --test cucumber`
  - Ask the user if questions arise

- [ ] 3. Expand property-based tests in perfgate-types
  - [ ] 3.1 Add property test for ConfigFile round-trip serialization
  ...
  - [ ] 3.2 Add property test for BenchConfigFile serialization
  ...
  - [ ] 3.3 Add property test for Budget and BudgetOverride types
...
- [ ] 4. Expand property-based tests in perfgate-domain
  - [ ] 4.1 Add property test for summarize_f64 ordering invariant
  ...
  - [ ] 4.2 Add property test for median algorithm edge cases
  ...
  - [ ] 4.3 Add unit tests for domain error conditions
...
- [ ] 5. Expand property-based tests in perfgate-adapters
  - [ ] 5.1 Add property test for output truncation
  ...
  - [ ] 5.2 Add unit tests for adapter error conditions
...
- [ ] 7. Expand fuzzing targets
  ...
  - [ ] 7.4 Add Arbitrary derive to types for structure-aware fuzzing
...
- [ ] 12. Final checkpoint - Comprehensive test verification
